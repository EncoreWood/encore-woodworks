...
const statusColumns = [
  { id: "inquiry", label: "New Inquiries", color: "bg-slate-100" },
  { id: "in_production", label: "In Production", color: "bg-amber-50" },
  { id: "ready_for_install", label: "Ready to Install", color: "bg-cyan-50" },
  { id: "installing", label: "Installing", color: "bg-orange-50" },
  { id: "urgent", label: "Urgent Items", color: "bg-red-50" }
];
...
export default function MorningMeeting() {
  ...
  const handleDragEnd = (result) => {
    ...
    const newStatus = destination.droppableId === "urgent" ? "in_production" : destination.droppableId;
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Morning Meeting</h1>
          <p className="text-slate-500 mt-1">Daily project overview and priorities</p>
        </div>
