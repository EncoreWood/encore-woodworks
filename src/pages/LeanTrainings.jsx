...
import { Plus, GraduationCap, Search, Pencil, Trash2, Loader2, Play, CheckCircle2, Video, HelpCircle } from "lucide-react";
...
export default function LeanTrainings() {
  ...
  const getCompletion = (trainingId) => {
    ...
    return myCompletions.reduce((best, c) => !best || c.score > best.score ? c : best, myForTraining[0]);
  };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Lean Training</h1>
            <p className="text-sm text-slate-500 hidden sm:block">Watch training videos and complete quizzes to build your lean skills</p>
          </div>
          {isAdmin && (
            <Button onClick={handleNew} className="bg-indigo-600 hover:bg-indigo-700 flex-shrink-0">
