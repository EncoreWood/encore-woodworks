              ...
              {viewType === "week" ? (
                <CalendarComponent
                  ...
                  classNames={{
                    ...
                    cell: "relative p-0 text-center border-2 border-slate-200 w-[14.28%] bg-slate-100",
                    day: "relative h-30 w-full p-0 font-normal hover:bg-amber-50 transition-colors bg-white",
                  ...
                  classNames={{
                    ...
                    head_cell: "text-slate-600 font-semibold text-base py-4 w-[14.28%]",
                    cell: "relative p-0 text-center border-2 border-slate-200 w-[14.28%] bg-slate-100",
                    day: "relative h-24 w-full p-0 font-normal hover:bg-amber-50 transition-colors bg-white",
                    day_selected: "bg-amber-100 text-amber-900 font-semibold",
                    day_today: "bg-blue-50 font-bold border-2 border-blue-300",
                    day_outside: "text-slate-300 opacity-50 bg-slate-50"
                  }}
                        ...
                        <div className="w-full h-full flex flex-col p-1 relative">
                          ...
                          <div className="absolute bottom-1 left-0 right-0 px-1 flex flex-col gap-0.5">
                            {(activeFilter === "all" || activeFilter === "projects") && spanningProjects.slice(0, 3).map((project) => (
                              <div
                                key={project.id}
                                className={!project.card_color ? `h-3.5 rounded-sm flex items-center px-0.5 overflow-hidden ${statusConfig[project.status]?.color || "bg-slate-400"}` : "h-3.5 rounded-sm flex items-center px-0.5 overflow-hidden"}
                                style={project.card_color ? { backgroundColor: project.card_color } : {}}
                                title={project.project_name}
                              >
