...
export default function ProposalTemplateForm({ template, onSave, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Template Info */}
      <Card className="p-4">
        <h3 className="font-semibold text-lg mb-4">Template Information</h3>
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g., Standard Kitchen Template"
              required
            />
          </div>
        </div>
      ...
      {/* Specifications */}
      <Card className="p-4">
        <h3 className="font-semibold text-lg mb-4">Default Specifications</h3>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-semibold text-lg">Default Options</h3>
      ...
      {/* Payment Terms */}
      <Card className="p-4">
        <h3 className="font-semibold text-lg mb-4">Default Payment Terms</h3>
        <Textarea
      ...
      {/* Notes */}
      <Card className="p-4">
        <h3 className="font-semibold text-lg mb-4">Default Notes</h3>
        <Textarea
